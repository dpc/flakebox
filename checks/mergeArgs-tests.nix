...
let
  ...
  assertEq =
    ...
    lib.assertMsg (actual == expected) "${name}: expected ${builtins.toJSON expected}, got ${builtins.toJSON actual}";
  ...
  r4 = mergeArgs { env = { A = "1"; }; } { env = { B = "2"; }; };
  r5 = mergeArgs { env = { A = "1"; }; } { env = { A = "2"; }; };
  r6 = mergeArgs { } { buildInputs = [ 1 ]; };
  r7 = mergeArgs { buildInputs = [ 1 ]; } { };
  r8 = mergeArgs { } { env = { A = "1"; }; };
  r9 = mergeArgs { env = { A = "1"; }; } { };
  r10 = mergeArgs { foo = "left"; } { bar = "right"; };
  r11 = mergeArgs { foo = "left"; } { foo = "right"; };
in

assert assertEq "buildInputs merges both sides" r1.buildInputs [ 1 2 ];
assert assertEq "nativeBuildInputs merges both sides" r2.nativeBuildInputs [ 1 2 ];
assert assertEq "packages merges both sides" r3.packages [ 1 2 ];
assert assertEq "env merges both sides" r4.env { A = "1"; B = "2"; };
